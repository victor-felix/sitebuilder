...
<fieldset>
	<div class="grid-4 first">
		<div class="tip">
			<h2>
				<?php echo s('Extensions') ?>
			</h2>
			<p>
				<?php echo s('you can enable extensions to add custom functionality to this category. The availability of extensions change according to the content type of the category.') ?>
			</p>
		</div>
	</div>
	<div class="grid-8">
		...
		<ul class="composed-list">
			...
			<li class="level-0"><a href="<?php echo $href ?>">
				<p class="title">
					...
					<br /> <span class="description"><?php echo s($extension->specification('description')) ?>
					</span>
				</p>
			</a>
			</li>
