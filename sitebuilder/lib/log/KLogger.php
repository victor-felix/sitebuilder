...
class KLogger
{
    ...
    {
        $this->log(func_get_args(), self::NOTICE);
    }
    ...
    {
        $this->log(func_get_args(), self::ERR);
    }
    ...
    {
        $this->log(func_get_args(), self::FATAL);
    }
    ...
    {
        $this->log(func_get_args(), self::ALERT);
    }
    ...
    {
        $this->log(func_get_args(), self::CRIT);
    }
    ...
    {
        $this->log(func_get_args(), self::EMERG);
    }
     ...
     */
    public function log($params, $severity)
    {
        if ($this->_severityThreshold >= $severity) {
            $status = $this->_getTimeLine($severity);
            $line = call_user_func_array('sprintf', $params);
