...
namespace :deploy do
  ...
  task :parse_api_doc do
    run "ruby #{release_path}/sitebuilder/script/parse_docs.rb #{release_path}/sitebuilder/doc/api_tech_spec.md #{release_path}/segments/meumobi/public/docs/api.html 'MeuMobi: Tech Spec'"
  end
