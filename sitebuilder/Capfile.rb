...
namespace :deploy do
  ...
  task :parse_api_doc do
    run "ruby #{release_path}/sitebuilder/script/parse_docs.rb #{release_path}/doc/api_specs.md #{release_path}/segments/meumobi/public/docs/api.html 'MeuMobi: Tech Spec'"
  end
